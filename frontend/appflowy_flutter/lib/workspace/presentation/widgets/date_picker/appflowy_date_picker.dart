  ...
  void onDateSelectedFromDatePicker(
    ...
    if (isRange) {
      if (newEndDateTime == null) {
        if (justChangedRange && dateTime != null) {
          justChangedRange = false;
        ...
        setState(() {
          ...
          focusedDateTime = getNewFocusedDay(combinedEndDateTime);
        });
      }
    } else {
