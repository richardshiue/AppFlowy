...
import 'package:appflowy/workspace/presentation/settings/pages/members/invitation/invite_member_by_email.dart';
import 'package:appflowy/workspace/presentation/settings/pages/members/invitation/invite_member_by_link.dart';
                ...
                : SettingsBody(
                    ...
                    children: [
                      if (state.myRole.canInvite) ...[
                        ...
                        // offset column spacing
                        VSpace(40.0 - 2 * theme.spacing.xl),
                      ],
                      _MemberList(
