...
SelectionMenuItem askAISlashMenuItem = SelectionMenuItem(
...
SelectionMenuItem summarizeSlashMenuItem = SelectionMenuItem(
  getName: () => "Summarize",
  keywords: _keywords,
  handler: (editorState, _, __) async =>
      _insertAiWriter(editorState, AiWriterCommand.summarize),
  icon: (_, isSelected, style) => SelectableSvgWidget(
    data: FlowySvgs.slash_menu_icon_ai_writer_s,
    isSelected: isSelected,
    style: style,
